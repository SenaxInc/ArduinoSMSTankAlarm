...
.tooltip-icon{display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;border-radius:var(--radius);background:var(--muted);color:white;font-size:10px;margin-left:6px;cursor:help}
