...
EthernetServer server(XXX);  // forward ports 80 and 8080 to internal port 2001
...
const int ticks_per_check = 38;
const int ticks_nosignalalarm = 2700;
        ...
        while (client.connected()) {
            if (client.available()) {   // client data available to read
                ...
                if (c == '\n' && currentLineIsBlank) {
                    ...
                    client.println("<html><head><title>Senax Tank Batteries</title></head><body>");
                    ...
                    client.println("</tr></table></td></tr></table></body></html>");
                    break;
                }
